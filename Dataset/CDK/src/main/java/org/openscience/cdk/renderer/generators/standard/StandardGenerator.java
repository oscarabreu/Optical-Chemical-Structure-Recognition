...
public final class StandardGenerator implements IGenerator<IAtomContainer> {
     ...
     * @throws IllegalArgumentException the highlight property was set but was not a
     *                                            {@link Color} instance
     */
     ...
     * @see #isPlainBond(IBond)
     * @see VecmathUtil#newVectorInLargestGap(List)
     */
    ...
    public static final class Visibility extends AbstractGeneratorParameter<SymbolVisibility> {
        ...
        public SymbolVisibility getDefault() {
            ...
            if(random3==0) {
                return SelectionVisibility.disconnected(SymbolVisibility.iupacRecommendations());
            }
            else {
