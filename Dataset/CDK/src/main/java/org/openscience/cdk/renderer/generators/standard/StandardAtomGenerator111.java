 ...
 * @author John May
 */
final class StandardAtomGenerator111 {
     ...
     */
    StandardAtomGenerator111(Font font) {
     ...
     */
    private StandardAtomGenerator111(Font font, double adjunctSpacing, double scriptSize) {
        this.font = font;
