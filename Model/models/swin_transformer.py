...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.scale = qk_scale or head_dim ** -0.5  # Scale factor for query-key dot product.


        # Relative position bias table - learns the relative positional information.
        ...
        # Layers for query, key, value computation and projection.
...
# SwinTransformerBlock: Basic building block of the Swin Transformer, combining attention and MLP.
...
class SwinTransformerBlock(nn.Module):
    ...
    # foward: Forward pass of the Swin Transformer block.
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        # Create a sequence of Swin Transformer Blocks.
...
# Swin Transformer: A PyTorch implementation of the Swin Transformer architecture,
# designed for computer vision tasks. It uses hierarchical vision transformers
# with shifted windows for efficient performance on image-based tasks.
# Reference: https://arxiv.org/pdf/2103.14030
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        # Constructor for the SwinTransformer class. Initializes the transformer with 
        # various parameters like image size, patch size, number of input channels, etc.
        ...
        dpr = [x.item() for x in torch.linspace(0, drop_path_rate, sum(depths))]  # Decay rule for depth

        # Building individual layers of the Swin Transformer.
        ...
        for i_layer in range(self.num_layers):
            ...
            self.layers.append(layer)  # Append the configured layer to the model

        self.norm = norm_layer(self.num_features)  # Normalization layer for the final feature vector

        self.apply(self._init_weights)  # Initialize weights of the model
